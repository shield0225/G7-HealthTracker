...
const HeartAndRespirationRateChart = () => {
    const { weekDates, nextWeek, prevWeek, isInitialState, reset, monthScope } = useWeeklyDate();
    ...
    const optionscolumnchart = { ...OPTIONS_CHART, xaxis: { categories: weekDates, } }
    ...
    return (
        <DashboardCard title="Heart and Respiration Rates" action={
            <WeekController showReset={!isInitialState} prevWeek={prevWeek} nextWeek={nextWeek} reset={reset} monthScope={monthScope} />
        }>
            <Chart
